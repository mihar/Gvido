...
describe Gig do
  ...
  it "shouldn't include a gig older then 3 months" do
    old_gig = Factory(:gig, :when => 4.month.ago )
  ...
  it "shouldn't include gigs without mentors" do
    ...
    Gig.with_mentors.should_not include(gig)
  end
